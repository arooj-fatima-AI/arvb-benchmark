...
ARVB operates within the category of AI Retrieval & Visibility Architecture and functions as its measurement layer.

This repository contains the formal benchmark definition, scoring model, and a sample evaluation for reproducibility and application.
